...
--Q8. what are the top 3 most purchased , and show the count of each segment?
with item_counts as (
select category, 
item_purchased,
...
--Q9. are customers who are repeat buyer (more than 5 previous purchase)also likely to subscribe?
select subscription_status,
